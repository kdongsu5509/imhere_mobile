...
final locationPermissionServiceProvider = Provider<PermissionServiceInterface>((
  ref,
) {
  return getIt<PermissionServiceInterface>(instanceName: 'location');
});

final contactPermissionServiceProvider = Provider<PermissionServiceInterface>((
  ref,
) {
  return getIt<PermissionServiceInterface>(instanceName: 'contact');
});

final fcmAlertPermissionServiceProvider = Provider<PermissionServiceInterface>((
  ref,
) {
