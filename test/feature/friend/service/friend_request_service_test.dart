    ...
    test('성공 시 생성된 요청 ID를 반환해야 함', () async {
      ...
      when(mockDio.post(
        ...
        options: anyNamed('options'),
            ...
            statusCode: 200,
            requestOptions:
                RequestOptions(path: ApiConfig.friendRequestPath),
          ));
    ...
    test('성공 시 상세 정보를 반환해야 함', () async {
      when(mockDio.get(
        ...
        options: anyNamed('options'),
            ...
            statusCode: 200,
            requestOptions:
                RequestOptions(path: ApiConfig.friendRequestDetailPath(1)),
          ));
    ...
    test('성공 시 친구 관계 정보를 반환해야 함', () async {
      when(mockDio.post(
        ...
        options: anyNamed('options'),
            ...
            statusCode: 200,
            requestOptions:
                RequestOptions(path: ApiConfig.friendRequestAcceptPath(1)),
          ));
    ...
    test('성공 시 true를 반환해야 함', () async {
      when(mockDio.post(
        ...
        options: anyNamed('options'),
            ...
            statusCode: 200,
            requestOptions:
                RequestOptions(path: ApiConfig.friendRequestRejectPath(1)),
          ));
